...
//			deleteAllStudentRecords(studentDAO);
	...
	private void createMultipleStudents(StudentDAO studentDAO) {
		System.out.println("Creating multiple students into the db ... ");
		// create the student object
		Faker faker = new Faker();

		Student studentOne = new Student(faker.name().firstName(), faker.name().lastName(), faker.internet().emailAddress());
		Student studentTwo = new Student(faker.name().firstName(), faker.name().lastName(), faker.internet().emailAddress());
		Student studentThree = new Student(faker.name().firstName(), faker.name().lastName(), faker.internet().emailAddress());
		...
		System.out.println("Saved student. Generated id: " + studentOne.getId()
				+"\n"+ studentTwo.getId() + "\n" + studentThree.getId());
	}
